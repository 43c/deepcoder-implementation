...
def compile_faster(source_code, LINQ, V, L, min_input_range_length=0):
    """ 
...
if __name__ == '__main__':    
    ...
    print("begin io generation test...")
    print()
    print(source)
    print()

    LINQ, _ = get_language(value_range)

    source = source.replace(' | ', '\n')
    program = compile_faster(source, LINQ, V=value_range, L=length)
